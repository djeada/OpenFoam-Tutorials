# Project 11 — Floating Boat Hull (6-DoF Rigid Body Motion)
...
2.  [Prerequisites — Run Project 10 First](#2-prerequisites--run-project-10-first)
3.  [What Makes This Different from Project 10](#3-what-makes-this-different-from-project-10)
...
Unlike Project 10 — where the hull was *fixed* in the domain and the water
...
## 2. Prerequisites — Run Project 10 First

**Project 10** (`10_boat_hull_flow/`) is the *fixed-hull* version of this
...
If you haven't run Project 10 yet, do that first. It teaches:
...
Project 11 builds on *all* of those skills and adds:
...
```
  Progression:   Project 07  →  Project 10  →  Project 11
...
## 3. What Makes This Different from Project 10

| Aspect                     | Project 10 (Fixed)           | Project 11 (Floating)              |
|----------------------------|------------------------------|-------------------------------------|
...
This is identical to Project 10 and Project 07.
...
The domain is slightly deeper than Project 10 (0.20 m vs 0.15 m) to give the
...
In Project 10, the boat was fixed, so we used `noSlip` (velocity = 0 at the
...
This file is **new in Project 11** — it doesn't exist in Project 10 because
the mesh was static.
...
Two-phase fluid properties — identical to Project 10.
...
Same as Project 10 plus dynamic mesh additions:
...
```bash
cd projects/11_boat_hull_floating
./Allrun
```
...
|---------|--------------------------|-----------|
| 07      | Dam Break                | VOF basics, free-surface initialisation |
| 10      | Fixed Boat Hull Flow     | **Direct prerequisite** — same geometry, static mesh |
| 11      | **This project**         | Floating hull with 6-DoF motion |
...
```
  ┌──────────────────────────────────────────────────────────────────┐
  │                                                                  │
  │  Project 07        Project 10          Project 11                │
  │  ┌──────────┐     ┌──────────────┐    ┌────────────────────┐    │
  │  │Dam Break │ ──→ │Fixed Hull    │ ──→│Floating Hull       │    │
...
```
projects/11_boat_hull_floating/
├── 0/
